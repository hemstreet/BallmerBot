...
Socket.prototype.setupListeners = function () {
    ...
    this.io.on('connection', function (socket) {
        ...
        socket.on('DRINK:WillGetAvailableDrinks', function() {
            this.ballmerBot.getAvailableDrinks();

            // When returns deferred, call .then
            //this.ballmerBot.getAvailableDrinks().then(function(drinks) {
            //    socket.emit('DRINK:DidGetAvailableDrinks', drinks);
            //}.bind(this));
        }.bind(this));
